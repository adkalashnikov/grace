...
<section class=" slide fade kenBurns  before" data-title="Студия" name="studio">
  ...
  <div class="background" style="background-image:url(http://gracestudio.com.ua/wp-content/uploads/2016/02/DB4_8738.jpg)"></div>
</section>


<section class="slide fade kenBurns before" data-title="Услуги" name="services">
  <div class="content">
    <div class="container">
      <div class="wrap-cont">
        <div class="t1185">
  ...
  <div class="background" style="background-image:url(http://gracestudio.com.ua/wp-content/uploads/2016/03/4-65-of-83.jpg)"></div>
</section>


<section class="slide fade kenBurns before" data-title="Магазин" name="shop">
  <div class="content">
    <div class="container">
      <div class="wrap-cont">
        <div class="t1185">
        ...
        <div class="w1185">
          <h2>Магазин</h2>
          <a href="<?php echo get_permalink(201); ?>" class="btn-more">посмотреть</a>
        </div>
  ...
  <div class="background" style="background-image:url(http://gracestudio.com.ua/wp-content/uploads/2016/02/DB4_9202.jpg)"></div>
</section>
...
<section class="slide fade kenBurns before" data-title="Наши работы" name="works">
  ...
  <div class="background" style="background-image:url(http://gracestudio.com.ua/wp-content/uploads/2016/03/jQByLWsRiQ0.jpg)"></div>
</section>

<section class="slide fade kenBurns before" data-title="Конткты" name="contacts">
  <div class="content">
    <div class="container">
      <div class="wrap-cont">
        <div class="t1185">
